...
rule to_code = parse
  ...
  | "bg:" ("#" hexcode as hex) { bg_from_hex hex }
  | "fg:" ("#" hexcode as hex) { fg_from_hex hex }
  | ("#" hexcode) as hex { fg_from_hex hex }

  (* xterm 256 colour names *)
  | "bg:" (name as color) { bg_from_name color }
  | "fg:" (name as color) { fg_from_name color }
  | name as color { fg_from_name color }
