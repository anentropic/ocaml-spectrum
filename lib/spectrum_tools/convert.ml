...
(*
  ...
  For perceptual matching we delegate nearest-colour search to palette
  modules generated by [%palette ...], which expose [nearest] backed by an
  octree built in LAB space (see spectrum_palette_ppx/palette.ml).
...
module Perceptual : Converter = struct
  ...
  *)
  ...
  module Ansi256_palette : Spectrum_palette_ppx.Palette.M =
    [%palette "lib/spectrum/256-colors.json"]
